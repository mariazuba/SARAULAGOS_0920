...
version_info+="Sardina Austral 2021";
  ...
  offset_dat.allocate("offset_dat");
  write_input_log<< version_info << endl;
  log_input(offset_dat)
 ad_comm::change_datafile_name("sard_austral.ctl");
...
log_prior_qmph =log(prior_qmph);
  ...
  offset_ctl.allocate("offset_ctl");
log_input(offset_ctl)
}
